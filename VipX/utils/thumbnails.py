...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"VipX/assets/anonx1.png")
        bg = Image.open(f"VipX/assets/anonx2.png")
        bg = Image.open(f"VipX/assets/anonx3.png")
        bg = Image.open(f"VipX/assets/anonx4.png")
        bg = Image.open(f"VipX/assets/anonx5.png")
        bg = Image.open(f"VipX/assets/anonx6.png")
        bg = Image.open(f"VipX/assets/anonx7.png")
        bg = Image.open(f"VipX/assets/anonx8.png")
        bg = Image.open(f"VipX/assets/anonx9.png")
        bg = Image.open(f"VipX/assets/anonx10.png")
        bg = Image.open(f"VipX/assets/anonx11.png")
